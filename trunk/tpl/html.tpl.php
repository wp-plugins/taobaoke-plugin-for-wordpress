...
<table cellpadding="0" cellspacing="0" bgcolor="%s" style="width:%dpx;border:1px solid #%s;">
  <tr>
    <td rowspan="2" align="center" style="height:82px">
      <div style="margin:5px auto; width:80px;height:80px;">
        <a class="taobaoke-status-tracking-by-gotall-net %s" target="_blank" href="%s" style="width:80px; margin:0px;padding:0px;height:80px;overflow:hidden;">
          <img style="margin:0px;border:none;width:80px;height:80px;" src="%s">
        </a>
      </div>
