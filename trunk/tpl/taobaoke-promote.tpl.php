...
<table style="width:100%">
    ...
    <tr>
        ...
        <td>
            ...
            <br /> <span style="color:#A9A9A9">更多选项开发中，<a href="http://blog.gotall.net/" target="_blank">招募开发者...</a></span>
        </td>
    </tr>
    <tr>
        <td colspan="3" align="center">
...
<br />
<ul>
    <li>您的推广列表中已经有<span style="font-weight:bold;font-size:14px;"> <?php _e_($item_count); ?> </span>件商品</li>
</ul>
