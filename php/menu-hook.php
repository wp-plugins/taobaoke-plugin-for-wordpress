...
function taobaoke_option_menu() {
    if (function_exists('add_options_page')) {
        ...
        add_submenu_page('taobaoke-settings.php', '淘宝客商品', '淘宝客商品推广', 'use taobaoke', 'taobaoke-products.php', TAOBAOKE_HOOK_MENU);
        add_submenu_page('taobaoke-settings.php', '淘宝客活动', '淘宝客活动推广', 'use taobaoke', 'taobaoke-activities.php', TAOBAOKE_HOOK_MENU);
        add_submenu_page('taobaoke-settings.php', '我的商品推广', '我推广的商品', 'use taobaoke', 'taobaoke-my-products.php', TAOBAOKE_HOOK_MENU);
        add_submenu_page('taobaoke-settings.php', '我的商品收藏', '我收藏的商品', 'use taobaoke', 'taobaoke-my-favs.php', TAOBAOKE_HOOK_MENU);
        add_submenu_page('taobaoke-settings.php', '我的商品推广', '推广统计', 'use taobaoke', 'taobaoke-my-analyse.php', TAOBAOKE_HOOK_MENU);
